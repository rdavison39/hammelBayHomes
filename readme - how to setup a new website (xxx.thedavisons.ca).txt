...
1. When you add a new site you need to add it to cloudflare (adding a new CNAME). No longer using Route 53 in Amazon as cloudflare helps me with SSL certs for free
2. Then you need to create a new bucket in S3 first as the endpoint will have to go into the CNAME properties
3. I use VS code to build the websites 
4. I use GitHub to manage the code. You can push changes using VS Code to GitHub
5. I have setup a workflow in GitHub to manage the workflow for all the websites. The workflow will push any changes from GitHub to Amazon S3
